...
export default function Header() {
  ...
  return (
    <header className="border-b border-surface-border bg-surface-1/50 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-za flex items-center justify-center text-white font-bold text-sm">
              VZ
            </div>
            <span className="font-bold text-lg tracking-tight hidden sm:block">VerifyZA</span>
          </Link>
